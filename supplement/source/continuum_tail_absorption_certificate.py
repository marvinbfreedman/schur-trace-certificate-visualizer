...
def main() -> None:
    ...
    continuum_tail_estimate_proved = bool(
    ...
    data = {
        ...
        "continuumTailEstimateProved": continuum_tail_estimate_proved,
        ...
        "conditionalTheorem": (
            ...
            "||(I-P_delta)E_Phi f||^2 <= epsilon_delta <A f,f> on "
            "H_M cap ker R_global is imported from the high-block tail "
            "passage theorem when available.  The finite low/mid Schur block "
            "absorbs this source-inactive tail because "
            "epsilonDeltaUpper < finiteLowMidSchurBudget."
        ),
        "remainingAnalyticGap": None
        if continuum_tail_estimate_proved and absorption_pass
        else (
    ...
    print(f"  continuum tail estimate proved: {continuum_tail_estimate_proved}")
